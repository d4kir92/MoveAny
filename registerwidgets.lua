...
function MoveAny:RegisterWidget(tab)
	...
	if frame ~= Minimap and frame ~= MinimapCluster and frame.SetIgnoreParentAlpha ~= nil and frame:GetParent() ~= UIParent and frame:GetParent() ~= MoveAny:GetMainPanel() then
