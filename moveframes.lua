		...
		if not InCombatLockdown() then
			for i, name in pairs(MAFS) do
				...
				if frame then
					...
					frame:HookScript("OnMouseDown", function(sel, btn)
					...
					frame:HookScript("OnMouseUp", function(sel)
