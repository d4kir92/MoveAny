...
function MoveAny:LangdeDE()
	local tab = {
		...
		["LID_BOSSTARGETFRAMECONTAINER"] = "Boss Behälter (Bossbehälter) (Überschreibt Boss1 - Boss5)",
		...
		["LID_BOSS1"] = "Boss 1 (Bossbehälter muss aus sein)",
		["LID_BOSS2"] = "Boss 2 (Bossbehälter muss aus sein)",
		["LID_BOSS3"] = "Boss 3 (Bossbehälter muss aus sein)",
		["LID_BOSS4"] = "Boss 4 (Bossbehälter muss aus sein)",
		["LID_BOSS5"] = "Boss 5 (Bossbehälter muss aus sein)",
		["LID_BOSS6"] = "Boss 6 (Bossbehälter muss aus sein)",
