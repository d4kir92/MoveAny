...
MoveAny:AddTrans("deDE", "LID_ALPHA", "Sichtbarkeit")
...
MoveAny:AddTrans("deDE", "LID_ANCHOR", "Ankerpunkt")
...
MoveAny:AddTrans("deDE", "LID_AUTO", "Automatisch")
...
MoveAny:AddTrans("deDE", "LID_BOTTOM", "Unten")
MoveAny:AddTrans("deDE", "LID_BOTTOMLEFT", "Unten links")
MoveAny:AddTrans("deDE", "LID_BOTTOMRIGHT", "Unten rechts")
...
MoveAny:AddTrans("deDE", "LID_CENTER", "Mitte")
...
MoveAny:AddTrans("deDE", "LID_DEFAULT", "Standard")
MoveAny:AddTrans("deDE", "LID_DIGITAL", "Digital")
...
MoveAny:AddTrans("deDE", "LID_DURATION", "Dauer")
...
MoveAny:AddTrans("deDE", "LID_EXPORT", "Exportieren")
...
MoveAny:AddTrans("deDE", "LID_FONT", "Schriftart")
MoveAny:AddTrans("deDE", "LID_FORMAT", "Format")
MoveAny:AddTrans("deDE", "LID_FRAMELEVEL", "Framelevel (fein)")
...
MoveAny:AddTrans("deDE", "LID_FULLHPENABLED", "Sichtbarkeit (Volle Gesundheit) aktiv")
...
MoveAny:AddTrans("deDE", "LID_GROWTH", "Wachstumsrichtung")
...
MoveAny:AddTrans("deDE", "LID_IMPORT", "Importieren")
...
MoveAny:AddTrans("deDE", "LID_LAYER", "Ebene")
MoveAny:AddTrans("deDE", "LID_LEAVEVEHICLE", "Fahrzeug verlassen Taste")
MoveAny:AddTrans("deDE", "LID_LEFT", "Links")
MoveAny:AddTrans("deDE", "LID_LEFTALIGNED", "Linksbündig")
MoveAny:AddTrans("deDE", "LID_LEFTCLICKTOSELECT", "Linksklick um das Element zu markieren")
MoveAny:AddTrans("deDE", "LID_LFGMINIMAPFRAME", "LFG Minimapknopf")
MoveAny:AddTrans("deDE", "LID_LIMIT", "Grenze")
...
MoveAny:AddTrans("deDE", "LID_OUTLINE", "Umrandung (Outline)")
...
MoveAny:AddTrans("deDE", "LID_RAIDFRAMESEDITMODEHINT", "Im Bearbeitungsmodus verschobene Schlachtzugsfenster machen dem Schlachtzugsmanager keinen Platz mehr und können ihn beim Aufklappen verdecken. Lösung: Bearbeitungsmodus -> %s -> \"%s\" -> Speichern.")
MoveAny:AddTrans("deDE", "LID_READYCHECKLISTENERFRAME", "Bereitschaftsprüfung-Popup")
MoveAny:AddTrans("deDE", "LID_RELOADANDREOPEN", "Neu laden & wieder öffnen")
...
MoveAny:AddTrans("deDE", "LID_RIGHT", "Rechts")
...
MoveAny:AddTrans("deDE", "LID_SAVEANDCLOSE", "Speichern & Schließen")
...
MoveAny:AddTrans("deDE", "LID_SECONDS", "Sekunden")
MoveAny:AddTrans("deDE", "LID_SECONDSPLAIN", "Sekunden (nur Zahl)")
...
MoveAny:AddTrans("deDE", "LID_SHORT", "Kurz")
...
MoveAny:AddTrans("deDE", "LID_SNAPTOELEMENTS", "An anderen Elementen einrasten (Kanten/Mitte)")
MoveAny:AddTrans("deDE", "LID_SNAPWINDOWSIZE", "Snapgröße (Fenster)")
MoveAny:AddTrans("deDE", "LID_SPACING", "Abstand (Lücke)")
MoveAny:AddTrans("deDE", "LID_SPACINGX", "Abstand Horizontal")
MoveAny:AddTrans("deDE", "LID_SPACINGY", "Abstand Vertikal")
MoveAny:AddTrans("deDE", "LID_SPELLACTIVATIONOVERLAYFRAME", "Zauber-Aktivierungs-Overlay (Class Proc)")
MoveAny:AddTrans("deDE", "LID_STACKTEXT", "Stack-Text")
...
MoveAny:AddTrans("deDE", "LID_TEXTSIZE", "Textgröße")
...
MoveAny:AddTrans("deDE", "LID_TOP", "Oben")
MoveAny:AddTrans("deDE", "LID_TOPLEFT", "Oben links")
MoveAny:AddTrans("deDE", "LID_TOPRIGHT", "Oben rechts")
