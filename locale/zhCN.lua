...
MoveAny:AddTrans("zhCN", "LID_ALPHA", "透明度")
...
MoveAny:AddTrans("zhCN", "LID_ANCHOR", "锚点")
...
MoveAny:AddTrans("zhCN", "LID_AUTO", "自动")
...
MoveAny:AddTrans("zhCN", "LID_BOTTOM", "底部")
MoveAny:AddTrans("zhCN", "LID_BOTTOMLEFT", "左下")
MoveAny:AddTrans("zhCN", "LID_BOTTOMRIGHT", "右下")
...
MoveAny:AddTrans("zhCN", "LID_CENTER", "居中")
...
MoveAny:AddTrans("zhCN", "LID_DEFAULT", "默认")
MoveAny:AddTrans("zhCN", "LID_DIGITAL", "数字")
MoveAny:AddTrans("zhCN", "LID_DISABLEMOVEMENT", "在MoveAny编辑模式时禁用移动键")
MoveAny:AddTrans("zhCN", "LID_DURABILITY", "装备耐久度")
MoveAny:AddTrans("zhCN", "LID_DURATION", "持续时间")
...
MoveAny:AddTrans("zhCN", "LID_EXPORT", "导出")
...
MoveAny:AddTrans("zhCN", "LID_FONT", "字体")
MoveAny:AddTrans("zhCN", "LID_FORMAT", "格式")
MoveAny:AddTrans("zhCN", "LID_FRAMELEVEL", "框架层级 (微调)")
...
MoveAny:AddTrans("zhCN", "LID_FULLHPENABLED", "启用透明度 (满血时)")
...
MoveAny:AddTrans("zhCN", "LID_GROWTH", "增长方向")
...
MoveAny:AddTrans("zhCN", "LID_IMPORT", "导入")
...
MoveAny:AddTrans("zhCN", "LID_LAYER", "层级")
MoveAny:AddTrans("zhCN", "LID_LEAVEVEHICLE", "离开载具按钮")
MoveAny:AddTrans("zhCN", "LID_LEFT", "左侧")
MoveAny:AddTrans("zhCN", "LID_LEFTALIGNED", "左对齐")
MoveAny:AddTrans("zhCN", "LID_LEFTCLICKTOSELECT", "左键点击高亮元素")
MoveAny:AddTrans("zhCN", "LID_LFGMINIMAPFRAME", "地下城查找器小地图按钮")
MoveAny:AddTrans("zhCN", "LID_LIMIT", "数量限制")
...
MoveAny:AddTrans("zhCN", "LID_OUTLINE", "描边")
...
MoveAny:AddTrans("zhCN", "LID_RAIDFRAMESEDITMODEHINT", "在编辑模式中移动过的团队框架不再为团队框架管理让出位置，展开时可能会遮住它。解决方法：编辑模式 -> %s -> \"%s\" -> 保存。")
MoveAny:AddTrans("zhCN", "LID_READYCHECKLISTENERFRAME", "就绪检查框")
MoveAny:AddTrans("zhCN", "LID_RELOADANDREOPEN", "重载并重新打开")
...
MoveAny:AddTrans("zhCN", "LID_RIGHT", "右侧")
...
MoveAny:AddTrans("zhCN", "LID_SAVEANDCLOSE", "保存并关闭")
...
MoveAny:AddTrans("zhCN", "LID_SECONDS", "秒")
MoveAny:AddTrans("zhCN", "LID_SECONDSPLAIN", "秒（仅数字）")
...
MoveAny:AddTrans("zhCN", "LID_SHORT", "简短")
...
MoveAny:AddTrans("zhCN", "LID_SNAPTOELEMENTS", "吸附到其他元素 (边缘/中心)")
MoveAny:AddTrans("zhCN", "LID_SNAPWINDOWSIZE", "吸附尺寸 (窗口)")
MoveAny:AddTrans("zhCN", "LID_SPACING", "间距")
MoveAny:AddTrans("zhCN", "LID_SPACINGX", "水平间距")
MoveAny:AddTrans("zhCN", "LID_SPACINGY", "垂直间距")
MoveAny:AddTrans("zhCN", "LID_SPELLACTIVATIONOVERLAYFRAME", "法术触发指示器 (职业特效)")
MoveAny:AddTrans("zhCN", "LID_STACKTEXT", "层数文字")
...
MoveAny:AddTrans("zhCN", "LID_SUPERTRACKEDFRAME", "路径点图标缩放")
...
MoveAny:AddTrans("zhCN", "LID_TEXTSIZE", "文字大小")
...
MoveAny:AddTrans("zhCN", "LID_TOP", "顶部")
MoveAny:AddTrans("zhCN", "LID_TOPLEFT", "左上")
MoveAny:AddTrans("zhCN", "LID_TOPRIGHT", "右上")
