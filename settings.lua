...
local config = {
	["title"] = format("MoveAny |T135994:16:16:0:0|t v|cff3FC7EB%s", "1.5.10")
}
...
local function AddCheckBox(x, key, val, func, id, editModeEnum, showReload)
	...
	if cbs[key] == nil then
		...
		cb.btn:SetScript("OnClick", function(sel)
	...
	if MAProfiles == nil then
		...
		MAProfiles.AddProfile:SetScript("OnClick", function()
			if MAAddProfile == nil then
				...
				MAAddProfile.Name:SetScript("OnTextChanged", function(sel, text)
				...
				if MAGetProfile.lines[id] == nil then
					...
					MAGetProfile.lines[id].btn:SetScript("OnClick", function()
						...
						if MADownloadProfile == nil then
							...
							MADownloadProfile.ProfileName:SetScript("OnTextChanged", function(sel, text)
			...
			if name ~= "DEFAULT" then
				...
				btnRen:SetScript("OnClick", function()
					if MARenameProfile == nil then
						...
						MARenameProfile.Name:SetScript("OnTextChanged", function(sel, text)
